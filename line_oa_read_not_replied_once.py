...
ใช้ .env: LINE_OA_URL, CHROME_DEBUG_PORT, LINE_OA_OPENCLAW_TARGET (ถ้าต้องการส่งผลไป openclaw)
...
if __name__ == "__main__":
    ...
    chrome_port = os.environ.get("CHROME_DEBUG_PORT", "").strip() or None
    ...
    parser.add_argument("--connect-chrome", type=str, default=chrome_port, metavar="PORT",
                        help="เชื่อมต่อ Chrome ที่เปิดอยู่แล้ว (หรือใช้ CHROME_DEBUG_PORT ใน .env)")
